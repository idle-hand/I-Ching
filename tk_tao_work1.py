...
Stillness and tranquillity set things in order in the universe.Forty-five
Great accomplishment seems imperfect,
Yet it does not outlive its usefulness.
Great fullness seems empty,
Yet cannot be exhausted.
...
Look at the universe as universe.
How do I know the universe is like this?
By looking!''','''He who is filled with Virtue is like a newborn child.
Wasps and serpents will not sting him;
Wild beasts will not pounce upon him;
He will not be attacked by birds of prey.
His bones are soft, his muscles weak,
...
while count < 64:
    ...
    button1 = Button(root, text='\nNEXT', width=25, command=root.destroy)
    button1.pack()
    button2  = Button(root, text='\nQUIT', width=25,command=quit )
    button2.pack()
